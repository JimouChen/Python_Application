...
class Graph:
    ...
    def add_edge(self, start_ver, end_ver, weight):
        ...
        self.vertex_list[start_ver].add_neighbor(self.vertex_list[end_ver].data, weight=weight)
    ...
    def show_all_msg(self):
        ...
        for i in range(self.num_vertex):
            msg.append(str(self.vertex_list[i]))
...
if __name__ == '__main__':
    ...
    print(g.vertex_list[0].get_connect_ver())
    print(g.num_vertex)
    print(g.get_all_ver())
    print(g.show_all_msg())
